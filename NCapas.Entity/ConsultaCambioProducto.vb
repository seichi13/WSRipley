Public Class ConsultaCambioProducto
    ...
    Private _tipo_Tarjeta_Inicial As String
    Public Property Tipo_Tarjeta_Inicial() As String
        Get
            Return _tipo_Tarjeta_Inicial
        End Get
        Set(ByVal value As String)
            _tipo_Tarjeta_Inicial = value
        End Set
    End Property

    Private _tipo_Tarjeta_Final As String
    Public Property Tipo_Tarjeta_Final() As String
        Get
            Return _tipo_Tarjeta_Final
        End Get
        Set(ByVal value As String)
            _tipo_Tarjeta_Final = value
        End Set
    End Property

    Private _fecha_Inicial_Oferta As DateTime
    Public Property Fecha_Inicial_Oferta() As DateTime
        Get
            Return _fecha_Inicial_Oferta
        End Get
        Set(ByVal value As DateTime)
            _fecha_Inicial_Oferta = value
        End Set
    End Property

    Private _fecha_Final_Oferta As DateTime
    Public Property Fecha_Final_Oferta() As DateTime
        Get
            Return _fecha_Final_Oferta
        End Get
        Set(ByVal value As DateTime)
            _fecha_Final_Oferta = value
        End Set
    End Property
